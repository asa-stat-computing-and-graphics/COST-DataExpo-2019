...
clean_data <- function(filename) {
  ...
  inputdata <- subset(inputdata, Householder.hispanic.origin!="8" & Plumbing.facilities!="8" & Kitchen.facilities!="8" & Householder.sex!="8") #removes 200 observations
